...
#args = c("../../../../output/chrX/chrX-154555919-INV-93915/relate/chrX-154555919-INV-93915.filter.noMissing.haps", "../../../../output/chrX/chrX-154555919-INV-93915/data/poplabels.relate",  "chrX-154555919-INV-93915",  "../iqtree_sliceFASTA",  "../../../../output/chrX/chrX-154555919-INV-93915/iqtree/chrX-154555919-INV-93915.timetree.nex",   "../../../../output/chrX/chrX-154555919-INV-93915/iqtree_sliceFASTA/all.minMutHomoplasy.dat",  "../../../../input/refSeq.hg38.uniq.bed",  20000,  "chrX-154555919-INV-93915",  "../../../../output/chrX/chrX-154555919-INV-93915/data/locus.bed")
...
if (length(mytimetree) != 1 ){
  ...
  pdf(sprintf("%s.TreeSimilarity.sliceTrees.pdf", outf_prefix), height = 6, width = 9, useDingbats = F)
  plot.new()
  dev.off()
}
