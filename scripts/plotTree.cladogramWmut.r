...
#args = c("tmm.wMut.new", "output/chr8/chr8-7411171-INV-4101483_1/data/mapping_hap_INV.txt", "tmm")
#args = c("output/chr8/chr8-7411171-INV-4101483_1/iqtree/chr8-7411171-INV-4101483_1.treefile.wMut.nwk", "output/chr8/chr8-7411171-INV-4101483_1/data/mapping_hap_INV.txt", "tmm")

#args = c("11p11.4.treefile.wMut.nwk", "../candidates_20kbAND2Mbp_auto_v3/output/chr11/chr11-50136371-INV-206505/data/mapping_hap_INV.txt", "11p11.4.treefile.wMut.nwk.pdf.cladogramMut.pdf")
