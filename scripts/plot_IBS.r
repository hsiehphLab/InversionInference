...
#args <- c("output/chr7/chr7-63356276-INV-31891/data/chr7-63356276-INV-31891.IBS.dat","output/chr7/chr7-63356276-INV-31891/data/chr7-63356276-INV-31891.elemDiff_pairHaps.dat","output/chr7/chr7-63356276-INV-31891/plot/chr7-63356276-INV-31891.pairwiseIBS.pdf","output/chr7/chr7-63356276-INV-31891/plot/chr7-63356276-INV-31891.addPadding.elemDiff_pairHaps.pdf")

#args <- c("output/chr10/chr10-46983452-INV-484782/data/chr10-46983452-INV-484782.IBS.dat", "output/chr10/chr10-46983452-INV-484782/data/chr10-46983452-INV-484782.elemDiff_pairHaps.dat","output/chr10/chr10-46983452-INV-484782/plot/chr10-46983452-INV-484782.pairwiseIBS.pdf", "output/chr10/chr10-46983452-INV-484782/plot/chr10-46983452-INV-484782.elemDiff_pairHaps.pdf")

#args = c("output/chr1/chr1-13084312-INV-62181/data/chr1-13084312-INV-62181.addPadding.IBS.dat", "output/chr1/chr1-13084312-INV-62181/data/chr1-13084312-INV-62181.addPadding.elemDiff_pairHaps.dat", "tmp.vcf.addPadding.IBS.dat.pdf", "tmp.vcf.addPadding.elemDiff_pairHaps.dat.pdf", "output/chr1/chr1-13084312-INV-62181/data/chr1-13084312-INV-62181.filter.noMissing.vcf.hap.tped", "output/chr1/chr1-13084312-INV-62181/data/chr1-13084312-INV-62181.filter.noMissing.addPadding.vcf.hap.tped")

#args = c("output/chr5/chr5-16979045-INV-519/data/chr5-16979045-INV-519.IBS.dat", "output/chr5/chr5-16979045-INV-519/data/chr5-16979045-INV-519.elemDiff_pairHaps.dat", "output/chr5/chr5-16979045-INV-519/plot/chr5-16979045-INV-519.pairwiseIBS.pdf", "output/chr5/chr5-16979045-INV-519/plot/chr5-16979045-INV-519.elemDiff_pairHaps.pdf")

#ibs <- read.delim("test")
#elemDiff_pairHaps <- read.delim("output/chr17/chr17-46489489-INV-653207_2/data/chr17-46489489-INV-653207_2.addPadding.elemDiff_pairHaps.dat", header=F, sep='')
ibs <- fread(args[1])
#elemDiff_pairHaps <- fread(args[2], header=F , sep='', na.strings = c("nan"))
outPDF1 <- args[3]
outPDF2 <- args[4]
...
#table_list_inv_anno <- table(list_inv_anno)

#start_groups <- c(1, unname(cumsum(table_list_inv_anno))+1)[-(length(table_list_inv_anno)+1)]
#end_groups <- unname(cumsum(table(list_inv_anno)))

#df_m3 <- data.frame(names=c("00","01","11"), labels = c("D/D","D/I","I/I"))

#curr_df_m3 <- droplevels(df_m3[ df_m3$names %in% names(table_list_inv_anno),])
#m3 <- curr_df_m3[,"names"]
