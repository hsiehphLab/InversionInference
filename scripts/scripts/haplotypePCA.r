...
#args = c("output/chr7/chr7-63356276-INV-31891/data/chr7-63356276-INV-31891.filter.noMissing.vcf.hap.tped",  "output/chr7/chr7-63356276-INV-31891/data/IDs_wPopID.hapID", "chr7-63356276-INV-31891", "output/chr7/chr7-63356276-INV-31891/data/chr7-63356276-INV-31891.filter.noMissing.vcf.hap.tfam")

#args = c("output/chrX/chrX-153066070-INV-17879/data/chrX-153066070-INV-17879.filter.noMissing.vcf.hap.tped",  "output/chrX/chrX-153066070-INV-17879/data/IDs_wPopID.hapID", "chrX-153066070-INV-17879", "output/chrX/chrX-153066070-INV-17879/data/chrX-153066070-INV-17879.filter.noMissing.vcf.hap.tfam")
...
#args = c("output/chr10/chr10-79526936-INV-290310/data/chr10-79526936-INV-290310.filter.noMissing.vcf.hap.tped", "output/chr10/chr10-79526936-INV-290310/data/IDs_wPopID.hapID", "chr10-79526936-INV-290310")

#args = c("output/chr10/chr10-46983452-INV-484782/data/chr10-46983452-INV-484782.filter.noMissing.vcf.hap.tped", "output/chr10/chr10-46983452-INV-484782/data/IDs_wPopID.hapID", "chr10-46983452-INV-484782")
...
# k-means
numK <- min(which(cumsum(summary_pca$importance[2,])>0.85)) # find num of PCs explains >85% variance
