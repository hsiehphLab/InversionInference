...
#args = c("output/chr11/chr11-50136371-INV-206505/relate/chr11-50136371-INV-206505.filter.noMissing.anc.haps", "input/poplabels.relate", "chr11-50136371-INV-206505", "output/chr11/chr11-50136371-INV-206505/relate/all.nwk", "output/chr11/chr11-50136371-INV-206505/iqtree/chr11-50136371-INV-206505.timetree.nex", "output/chr11/chr11-50136371-INV-206505/relate/all.minMutHomoplasy_phylo.dat","tmp")
...
mytimetree2[[INV_ID]]$edge.length <- mytimetree2[[INV_ID]]$edge.length
...
df_homoplasy$totalBranchLength <- apply(df_homoplasy, 1, function(x) ifelse(x[1]==INV_ID, sumBranchLength(x[1], mytimetree2, "phylo"), sumBranchLength(x[1], mytimetree2, "relate")))
